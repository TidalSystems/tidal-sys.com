...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
   <script type="text/javascript" src="<?php echo APP_BASEURL ?>/ui/editor/tinymce/tiny_mce.js"></script>
...
class Form_Option3 extends Form_SuperForm
...

{
...

	{
  	...
  	$this->TextErea('notes', 'Notes', '$rows = 40' , $id='elm2', false ); 
 	$this->TextErea('time', 'Delivery Time', '$rows = 40' , $id='elm3', false ); 
