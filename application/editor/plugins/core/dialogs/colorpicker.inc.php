<? $SpawConfig= new SpawConfig();?><script type="text/javascript" src="<?php echo $SpawConfig->getStaticConfigValue('SPAW_DIR') ?>plugins/core/dialogs/colorpicker.js"></script>
