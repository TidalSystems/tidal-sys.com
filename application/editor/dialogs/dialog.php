...
$SpawTheme = new SpawTheme($SpawVars->getGetVar("theme"));
...
$htpl = str_replace('{SPAW DIR}', $config->getStaticConfigValue('SPAW_DIR'), $htpl);
$ftpl = $theme->getTemplateDialogFooter(); 
$ftpl = str_replace('{SPAW DIR}', $config->getStaticConfigValue('SPAW_DIR'), $ftpl);
