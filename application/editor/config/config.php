...
$PATH = array ();
$PATH['doc_root'] = $_SERVER['DOCUMENT_ROOT'] = str_replace( '\\', '/', substr($_SERVER['SCRIPT_FILENAME'], 0, 0-strlen($_SERVER['PHP_SELF'])));
$PATH['spaw_root'] = str_replace ('\\', '/', dirname(__FILE__));
$PATH['spaw_root'] = substr ($PATH['spaw_root'], 0, -6);
$PATH['spaw_dir'] = str_replace ($PATH['doc_root'], '', $PATH['spaw_root']);

require_once($PATH['spaw_root'].'class/config.class.php');
require_once($PATH['spaw_root'].'class/util.class.php');
//echo($PATH['doc_root']);
$SpawConfig = new SpawConfig();
			$SpawConfig->setStaticConfigItem('DOCUMENT_ROOT', $PATH['doc_root']);
			$SpawConfig->setStaticConfigItem('SPAW_ROOT', $PATH['spaw_root']);
			$SpawConfig->setStaticConfigItem('SPAW_DIR', $PATH['spaw_dir']);


//$SpawConfig->setStaticConfigItem('DOCUMENT_ROOT',"D:/ftp/Max/F8.MaxMize.com/www/");
//$SpawConfig->setStaticConfigItem('SPAW_ROOT',"D:/ftp/Max/F8.MaxMize.com/www/Public/spaw2/");
//$SpawConfig->setStaticConfigItem('SPAW_DIR',"/Public/spaw2/");

//echo('doc_root '. $PATH['doc_root']."<br/>");
//echo('spaw_root '.$PATH['spaw_root']."<br/>");
//echo( 'spaw_dir '.$PATH['spaw_dir']."<br/>");
...
// language 
//echo($SpawConfig->getStaticConfigValue('SPAW_DIR').'wysiwyg.css');
...
// stylesheet
$SpawConfig->setStaticConfigItem('default_stylesheet','../wysiwyg.css');
// width 
...
$SpawConfig->setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => 'Public/flashes/',
	 // 'fsdir'   => $SpawConfig->getStaticConfigValue('DOCUMENT_ROOT').'Public/flashes/',
    ...
    array(
      'dir'     =>'Public/images/',
	  //'fsdir'   => $SpawConfig->getStaticConfigValue('DOCUMENT_ROOT').'Public/images/',
      'caption' => 'Images',
      'params'  => array(
    ...
    array(
      'dir'     => 'Public/files/',
     //'fsdir'   => $SpawConfig->getStaticConfigValue('DOCUMENT_ROOT').'Public/files/',
      'caption' => 'Files', 
      'params'  => array(
