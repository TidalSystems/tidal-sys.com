...

{
...

    {
        ...
        $form = new Form_Footer();

        $model = new Model_Footer();

        $confData = $model->optionselect('siteConffooter' ,$this->view->lang);
...

        {
            ...
            $model-> updateoneop('siteConffooter' , $formData ,$this->view->lang);
