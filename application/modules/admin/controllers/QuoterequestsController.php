<?php class Admin_QuoterequestsController extends CL_Curd_CurdContoller{    
public function init()  
 ...
 $this->listValue = array( 'created_on'=>'Created on',  'email'=>'Email' , 'title'=>'Name');       
 $this->formClass = new Form_Quoterequests();       
 $this->view->typename = 'Quote Requests';  
 $this->view->typename2 = 'Quoterequests';   
 $this->view->Sort = 'no';   
}  
