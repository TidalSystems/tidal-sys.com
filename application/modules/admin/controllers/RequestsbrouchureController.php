<?php class Admin_RequestsbrouchureController extends CL_Curd_CurdContoller{    
public function init()  

  {        
 $this->dbmodelClass = new Model_PlusData();       
 $this->dbmodelClass->_name = 'requestsbrouchure';     
 ...
 $this->formClass = new Form_Requestsbrouchure();       
 $this->view->typename = 'Requests Brochures';    
}  
