<?php class Admin_RequestnewsletterController extends CL_Curd_CurdContoller{    
public function init()  

  {        
 $this->dbmodelClass = new Model_PlusData();       
 $this->dbmodelClass->_name = 'requestnewsletter';     

 $this->listValue = array('email2'=>'Email Address'   , 'FIRSTNAME2'=>'First Name' , 'LASTNAME2'=>'Last Name' );       
 $this->formClass = new Form_Requestnewsletter();       
 $this->view->typename = 'Requests Newsletter';    
}  
 
 public function indexAction() {   

        $this->view->Custom = 'Newsletter';     
 parent::indexAction();    
}   
