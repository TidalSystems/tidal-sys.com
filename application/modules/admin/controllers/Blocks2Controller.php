...
class Admin_Blocks2Controller extends CL_Curd_CurdContoller
{
    public function init()
    {
        $this->dbmodelClass = new Model_PlusData();
        $this->dbmodelClass->_name = 'pages_blocks2';
        $this->listValue = array('img:image'=>'Image', 'data5'=>'From Page' , 'displayorder'=>'Display Order');
        $this->formClass = new Form_Blocks2();
        $this->view->typename = 'FAQ, Accordion Page Style';
    }
    public function indexAction() {
        $this->view->Custom = 'blocksxx';
