...

{
...

    {
        ...
        $confData = $model->optionselect('siteConfMessage' ,$this->view->lang);
...

        {
            ...
            $model-> updateoneop('siteConfMessage' , $formData ,$this->view->lang);
...
$time1=date("h:i:s");
 ...
 $sql="INSERT INTO  logs (action,user,userid,actiondetails,tablename,createdate,createtime) VALUES ('Edit', '$userfullname' , '$userid' , ' <spam style=color:red> Messages Content</spam> ' , 'Messages' , '$date1' , '$time1' ) ";
