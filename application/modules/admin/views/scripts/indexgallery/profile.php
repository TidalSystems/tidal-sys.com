...
/*********************************************************************
     ...
     ***********************************************************************/
	 ...
	 function changeAvatar() {
        ...
        {
        $actual_image_name2 = 'mainlyvacationdeals' .'_'.$name .'.'.$ext;
         $actual_image_name = mt_rand().str_replace(' ', '_', $actual_image_name2);
...
$sql = "UPDATE $ttabel SET $tfield= CONCAT('||$actual_image_name', $tfield)  WHERE id= $tid";
