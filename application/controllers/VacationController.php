...
class VacationController extends Zend_Controller_Action {
...

    {
        ...
        $form = new Form_Vacation();

        $this->dbmodelClass = new Model_PlusData();

        $this->dbmodelClass->_name = 'vacation';
        ...
        if($this->_request->isPost() && $form->isValid($_POST)) {   
          ...
          $dataForm = $form->getValues(); 
           ...
           $title = 'Customize Vacation';

           $dataForm = $form->getValues();

           $message = $this->view->partial(

                        'templates/contactvacation.html',
