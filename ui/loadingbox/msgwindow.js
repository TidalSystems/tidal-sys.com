...
(function ($) {
        ...
        $("BODY").append(
		  '<div id="processing_container">' +
		    ...
		    '<div id="processing_content">' +
		      '<div id="processing_message">'+ progText +'<br/><br/><img src="'+LOCALPATH+'/ui/loadingbox/image/loadingfinal.gif" alt="Loading..." /></div>' +
			'</div>' +
		  '</div>');
    ...
    {
		$("#processing_container").fadeOut(2000);
		$("#processing_overlay").fadeOut(2000);
		setTimeout(function(){
