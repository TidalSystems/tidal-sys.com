<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../../MyUpload/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../../MyUpload/'; // absolute or relative from this script path, required.
